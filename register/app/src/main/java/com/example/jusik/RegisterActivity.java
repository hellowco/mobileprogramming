...
//                final String PassCk=et_passck.getText().toString();
                ...
                if(userID.equals("") || userPass.equals("") || userName.equals("") || userEmail.equals("")){
                    Toast.makeText(getApplicationContext(), "필수항목이 빈칸입니다", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (!validate){
                    Toast.makeText(getApplicationContext(), "아이디 중복 검사 필요", Toast.LENGTH_SHORT).show();
                    return;
                }
